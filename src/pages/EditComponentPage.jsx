  ...
  useEffect(() => {
    ...
    if (comp) {
      setFormData({
        ...
        code: comp.code,
        tags: comp.tags ? comp.tags.join(', ') : '',
        dependencies: comp.dependencies ? comp.dependencies.join(', ') : '',
      });
    ...
    >
      <div className="flex min-h-screen relative w-full bg-black md:pl-80">
        ...
        <div className="flex-1 px-6 flex flex-col gap-5 min-w-0 pt-14 pb-20">
          ...
          <h1 className="font-bold text-5xl mb-2">Edit Component</h1>
          <p className="text-neutral-400 text-lg mb-8">Update your existing UI component.</p>

          {initialLoad ? (
            <div className="text-neutral-400">Loading component data...</div>
          ) : (
